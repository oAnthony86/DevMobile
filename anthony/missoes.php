            ...
            <div class="row">
              <div class="col-md-4">
                <div class="card mb-4 shadow-sm">
                  ...
                  <div class="card-body">
                    <p class="card-text">IR A LUA. Levar um homem a lua pela primeira vez na história.</p>
              ...
              <div class="col-md-4">
                <div class="card mb-4 shadow-sm">
                  <img class="card-img-top" src="https://uploads.jovemnerd.com.br/wp-content/uploads/2022/03/nasa-artemis-missao-lua.jpg" alt="Card image cap">
                  <div class="card-body">
                    <p class="card-text">MANDAR SATELITE COM MACACO. Enviar um satelite ao espaço, juntamente com um ser vivo.</p>
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="btn-group">
                      </div>
                    </div>
              ...
              <div class="col-md-4">
                <div class="card mb-4 shadow-sm">
                  <img class="card-img-top" src="https://uploads.jovemnerd.com.br/wp-content/uploads/2022/03/nasa-artemis-missao-lua.jpg" alt="Card image cap">
                  <div class="card-body">
                    <p class="card-text">IR AO SOL. Tentar chegar ao sol durante a noite.</p>
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="btn-group">
                      </div>
                    </div>
